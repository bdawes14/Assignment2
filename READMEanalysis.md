**Cohort Data Analysis: Assignment 2**

In this data we analyzed the associations between sex, smoking status, cardiac disease, and cost. As there was not a data dictionary, I am assuming "cardiac" is cardiac disease and "cost" is something like healthcare cost per year.  
...
-Generative AI/LLMs were not used in the generation of this report. 
